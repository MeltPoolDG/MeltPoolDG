...
namespace MeltPoolDG::LevelSet
{
  ...
  ReinitializationEllipticOperationNonLinear<dim, number>::
  ...
  template <int dim, typename number>
  void
  ReinitializationEllipticOperationNonLinear<dim, number>::solve()
  {
  ...
  template <int dim, typename number>
  void
  ReinitializationEllipticOperationNonLinear<dim, number>::solve_one_iter()
  {
  ...
  template <int dim, typename number>
  void
  ReinitializationEllipticOperationNonLinear<dim, number>::reinit()
  {
  ...
  template <int dim, typename number>
  void
  ReinitializationEllipticOperationNonLinear<dim, number>::set_initial_condition(
  ...
  template <int dim, typename number>
  const typename ReinitializationEllipticOperationNonLinear<dim, number>::VectorType &
  ReinitializationEllipticOperationNonLinear<dim, number>::get_level_set() const
  {
    return solution_level_set;
  }

  template <int dim, typename number>
  typename ReinitializationEllipticOperationNonLinear<dim, number>::VectorType &
  ReinitializationEllipticOperationNonLinear<dim, number>::get_level_set()
  {
    return solution_level_set;
  }
  ...
  template <int dim, typename number>
  number
  ReinitializationEllipticOperationNonLinear<dim, number>::get_relative_change_level_set() const
  {
  ...
  template <int dim, typename number>
  void
  ReinitializationEllipticOperationNonLinear<dim, number>::attach_vectors(
  ...
  template <int dim, typename number>
  void
  ReinitializationEllipticOperationNonLinear<dim, number>::attach_output_vectors(
  ...
  ReinitializationEllipticOperationNonLinear<dim, number>::create_operator()
  {
    ...
    preconditioner = make_preconditioner<dim,
                                         number,
                                         ReinitializationEllipticOperatorNonLinear<dim, number>,
  ...
  template <int dim, typename number>
  void
  ReinitializationEllipticOperationNonLinear<dim, number>::compute_intersected_quadrature()
  {
    level_set_old.update_ghost_values();
  ...
  template class ReinitializationEllipticOperationNonLinear<1, double>;
  template class ReinitializationEllipticOperationNonLinear<2, double>;
  template class ReinitializationEllipticOperationNonLinear<3, double>;
} // namespace MeltPoolDG::LevelSet
