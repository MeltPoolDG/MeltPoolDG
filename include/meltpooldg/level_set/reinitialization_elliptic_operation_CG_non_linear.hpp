...
/**
 * @brief This operation solves the reinitialization problem for a CG-FEM-based discrete
 * level-set field by solving an elliptic problem using analytical implicit Newton-Raphson method.
 *
...
namespace MeltPoolDG::LevelSet
{
  ...
  public:
    ...
    /**
     * @brief Solve the elliptic reinitialization problem using analytical implicit Newton-Raphson method.
     */
    void
    solve() override;

    /**
     * @brief Solve one Newton-Raphson iteration for the elliptic reinitialization problem.
     */
    void
    solve_one_iter();
    ...
    /**
     * @brief Get the relative change of the level set L2 norm between the current and previous Newton-Raphson iteration.
     *
  ...
  private:
    ...
    /// Vector for the right-hand side of the Newton-Raphson iteration (residuum).
    VectorType rhs;
    // level set field from the previous step: initial condition
    VectorType level_set_old;
    // level set update from the new Newton-Raphson iteration
    ...
    /// Relative change of the level L2 norm between the current and previous Newton-Raphson
    /// iteration.
